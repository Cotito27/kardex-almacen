...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.stockRead);
        const payload = yield new stockService_1.default(req).findById(req.params.id);
...
//# sourceMappingURL=stockFind.js.map