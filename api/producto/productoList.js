...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.productoRead);
        const payload = yield new productoService_1.default(req).findAndCountAll(req.query);
...
//# sourceMappingURL=productoList.js.map