...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.productoEdit);
        const payload = yield new productoService_1.default(req).update(req.params.id, req.body.data);
...
//# sourceMappingURL=productoUpdate.js.map