...
class ProductoRepository {
    ...
    static findAndCountAll({ filter, limit = 0, offset = 0, orderBy = '' }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.precioInicialRange) {
                    const [start, end] = filter.precioInicialRange;
                    if (start !== undefined && start !== null && start !== '') {
                        criteriaAnd.push({
                            precioInicial: {
                                $gte: start,
                ...
                if (filter.fechaVencimientoRange) {
                    const [start, end] = filter.fechaVencimientoRange;
                    if (start !== undefined && start !== null && start !== '') {
                        criteriaAnd.push({
                            fechaVencimiento: {
                                $gte: start,
    ...
    static findAllAutocomplete(search, limit, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sort = mongooseQueryUtils_1.default.sort('descripcion_ASC');
            const limitEscaped = Number(limit || 0) || undefined;
